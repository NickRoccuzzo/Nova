        ...
        html.Div([
            dash_table.DataTable(
                ...
                style_cell_conditional=[
                    ...
                    {'if': {'column_id': 'expiration_date'}, 'width': '90px'},
                    {'if': {'column_id': 'DTE'}, 'width': '35px'},
                    {'if': {'column_id': 'strike'}, 'width': '100px'},
                    {'if': {'column_id': 'volume'}, 'width': '70px'},
                    {'if': {'column_id': 'openInterest'}, 'width': '70px'},
                    {'if': {'column_id': 'unusualness'}, 'width': '70px'},
                    {'if': {'column_id': 'total_spent'}, 'width': '110px'},
                ],
                style_header={
